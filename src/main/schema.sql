...
--
-- Host: 172.22.219.59    Database: npCite
-- ------------------------------------------------------
...
INSERT INTO `commodity` VALUES (1,'虎鲸抱枕','抱着很舒服',100,7,3,1,100);
...
INSERT INTO `log` VALUES (6,3,'用户（id：3|name:admin)打开了商品(id:1|name:虎鲸抱枕)的详细信息进行了浏览','2021-12-14 23:51:51'),(7,3,'用户（id：3|name:admin)打开了商品(id:1|name:虎鲸抱枕)的详细信息进行了浏览','2021-12-15 00:12:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购物车记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'npC4t','scut@1234','123@123.com',0),(3,'admin','123456','111@12.com',99400),(6,'admin123','123456','111@123.com',0);
...
-- Dump completed on 2021-12-15  0:17:20
